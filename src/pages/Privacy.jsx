  ...
  return (
    <div className="bg-[#020617] text-[#e2e8f0] min-h-screen pt-16">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-[#f8fafc] to-[#06b6d4] bg-clip-text text-transparent">
          Privacy Policy
        </h1>
        <p className="text-gray-400 mb-8">Last Updated: June 2023</p>
        
        <div className="bg-[rgba(30,41,59,0.6)] rounded-xl p-6 mb-8 border border-[rgba(100,116,139,0.2)]">
        ...
        <div className="bg-[rgba(30,41,59,0.6)] rounded-xl p-6 mb-8 border border-[rgba(100,116,139,0.2)]">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#3b82f6]">1. Information We Collect</h2>
        ...
        <div className="bg-[rgba(30,41,59,0.6)] rounded-xl p-6 mb-8 border border-[rgba(100,116,139,0.2)]">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#3b82f6]">2. How We Use Your Information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            <div className="bg-[rgba(30,41,59,0.5)] p-5 rounded border-l-4 border-[#3b82f6]">
              ...
              <p className="text-sm">To provide and improve our AI consulting services and solutions</p>
            </div>
            <div className="bg-[rgba(30,41,59,0.5)] p-5 rounded border-l-4 border-[#3b82f6]">
              <h3 className="text-lg font-semibold mb-2">Communication</h3>
              <p className="text-sm">To respond to inquiries and provide project updates</p>
            </div>
            <div className="bg-[rgba(30,41,59,0.5)] p-5 rounded border-l-4 border-[#3b82f6]">
              <h3 className="text-lg font-semibold mb-2">AI Development</h3>
              <p className="text-sm">To train and improve our AI models and algorithms</p>
            </div>
          </div>
        </div>
        
        <div className="bg-[rgba(30,41,59,0.6)] rounded-xl p-6 mb-8 border border-[rgba(100,116,139,0.2)]">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#3b82f6]">3. Data Protection</h2>
        ...
        <div className="bg-[rgba(30,41,59,0.6)] rounded-xl p-6 mb-8 border border-[rgba(100,116,139,0.2)]">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#3b82f6]">4. Your Rights</h2>
        ...
        <div className="bg-[rgba(30,41,59,0.6)] rounded-xl p-6 mb-8 border border-[rgba(100,116,139,0.2)]">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#3b82f6]">5. Changes to This Policy</h2>
        ...
        <div className="bg-[rgba(30,41,59,0.6)] rounded-xl p-6 mb-8 border border-[rgba(100,116,139,0.2)]">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#3b82f6]">6. Contact Us</h2>
